                    ...
                    <div style={{ 
                        ...
                        <div style={{
                            ...
                            <ReactMarkdown 
                                ...
                                components={{
                                    h1: ({children}) => <h1 style={{color: '#212529', marginTop: 0, marginBottom: '0.8rem', fontSize: '1.5rem', fontWeight: 700, borderBottom: '2px solid #dee2e6', paddingBottom: '0.4rem'}}>{children}</h1>,
                                    h2: ({children}) => <h2 style={{color: '#495057', marginTop: '1.2rem', marginBottom: '0.8rem', fontSize: '1.3rem', fontWeight: 600}}>{children}</h2>,
                                    h3: ({children}) => <h3 style={{color: '#495057', marginTop: '1rem', marginBottom: '0.6rem', fontSize: '1.1rem', fontWeight: 600}}>{children}</h3>,
                                    p: ({children}) => <p style={{marginBottom: '0.8rem', color: '#212529', fontSize: '13px'}}>{children}</p>,
                                    ul: ({children}) => <ul style={{marginBottom: '0.8rem', paddingLeft: '1.2rem'}}>{children}</ul>,
                                    ol: ({children}) => <ol style={{marginBottom: '0.8rem', paddingLeft: '1.2rem'}}>{children}</ol>,
                                    li: ({children}) => <li style={{marginBottom: '0.2rem', color: '#212529', fontSize: '13px'}}>{children}</li>,
                                    blockquote: ({children}) => <blockquote style={{borderLeft: '4px solid #ffd700', paddingLeft: '0.8rem', margin: '0.8rem 0', fontStyle: 'italic', color: '#6c757d', fontSize: '13px'}}>{children}</blockquote>,
                                    code: ({inline, children}) => inline ? 
                                        <code style={{background: '#f8f9fa', color: '#e83e8c', padding: '0.1rem 0.2rem', borderRadius: '0.25rem', fontSize: '12px', border: '1px solid #dee2e6'}}>{children}</code> :
                                        <code style={{display: 'block', background: '#f8f9fa', color: '#212529', padding: '0.8rem', borderRadius: '0.5rem', fontSize: '12px', border: '1px solid #dee2e6', overflowX: 'auto'}}>{children}</code>,
                                    ...
                                    hr: () => <hr style={{border: 'none', borderTop: '1px solid #dee2e6', margin: '1.5rem 0'}} />,
                                    ...
                                    input: ({type, checked, ...props}) => {
                                        if (type === 'checkbox') {
                                            return <input type="checkbox" checked={checked} readOnly style={{marginRight: '0.4rem', accentColor: '#ffd700'}} {...props} />;
                                        }
